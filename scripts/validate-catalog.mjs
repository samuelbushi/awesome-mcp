...
const requiredFieldNames = ["slug", "name", "category", "description", "homepage_url", "license", "status"];
...
if (entryFilePaths.length === 0) {
  console.log('No MCP server entries found yet. Empty catalog is valid.');
}
...
console.log(`Validated ${entryFilePaths.length} MCP server entries.`);
